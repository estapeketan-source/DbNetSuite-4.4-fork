...
namespace Winista.Mime
{
	...
	public sealed class MimeTypes
    {
        ...
        public MimeTypes(System.Xml.XmlDocument document)
        {
            MimeTypesReader reader = new MimeTypesReader();
            Add(reader.Read(document));
        }
		...
		/// </returns>
		internal MimeType GetMimeType(System.Uri url)
		{
		...
		/// <code>null</code> if none is found.
		/// </returns>
		internal MimeType GetMimeType(System.String name)
		{
		...
		/// </seealso>
		internal MimeType GetMimeType(sbyte[] data)
		{
			// Preliminary checks
		...
		/// <seealso cref="#getMinLength()">
		/// </seealso>
		internal MimeType GetMimeType(System.String name, sbyte[] data)
		{
		...
		internal MimeType ForName(System.String name)
		{
